...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/irc/main.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _connect_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./connect.js */ \"./src/irc/connect.js\");\n/* harmony import */ var _image_open_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../image/open.js */ \"./src/image/open.js\");\n/* harmony import */ var _shell_makeParser_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../shell/makeParser.js */ \"./src/shell/makeParser.js\");\n// This file is a part of Denshi.\n// Copyright (C) 2019 Matthew Blount\n\n// This program is free software: you can redistribute it and/or modify\n// it under the terms of the GNU Affero General Public License as\n// published by the Free Software Foundation, either version 3 of the\n// License, or (at your option) any later version.\n\n// This program is distributed in the hope that it will be useful, but\n// WITHOUT ANY WARRANTY; without even the implied warranty of\n// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU\n// Affero General Public License for more details.\n\n// You should have received a copy of the GNU Affero General Public\n// License along with this program.  If not, see\n// <https://www.gnu.org/licenses/.\n\n\n\n\n\nconst nickname = process.env.DENSHI_IRC_NICKNAME;\nconst password = process.env.DENSHI_IRC_PASSWORD;\nconst channel  = process.env.DENSHI_IRC_CHANNEL;\nconst address  = process.env.DENSHI_IRC_ADDRESS;\nconst port     = process.env.DENSHI_IRC_PORT;\n\nlet image = Object(_image_open_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\nlet parse = Object(_shell_makeParser_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(image);\nlet handle = Object(_connect_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(\n  { nickname, password, channel, address, port },\n  async (line) => {\n    let command = parse(line);\n    let response = await command();\n    return response;\n  },\n);\n\n\n//# sourceURL=webpack:///./src/irc/main.js?");
